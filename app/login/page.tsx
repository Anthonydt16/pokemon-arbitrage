...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <p className="text-gray-400 text-sm mb-6">Connectez-vous pour voir et gérer vos recherches privées.</p>
      ...
      <p className="text-sm text-gray-400 mt-4 text-center">
        Pas de compte ?{' '}
        <Link href="/register" className="text-yellow-400 hover:underline">Inscription</Link>
      </p>
    </div>
  )
}
