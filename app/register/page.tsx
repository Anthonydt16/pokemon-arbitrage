...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <p className="text-gray-400 text-sm mb-6">Créez votre compte pour sauvegarder vos recherches personnelles.</p>
      ...
      <p className="text-sm text-gray-400 mt-4 text-center">
        Déjà un compte ?{' '}
        <Link href="/login" className="text-yellow-400 hover:underline">Connexion</Link>
      </p>
    </div>
  )
}
